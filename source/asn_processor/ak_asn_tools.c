...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param str строка, содержащая символы '1' и '0', определяющие битовую строку
...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param val64 беззнаковое число, двоичное представление которого определяет битовую строку
    @param used_bits количество младших бит в числе val64, которые задают битовою строку
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param p_data указатель на массив байтов, которые определяют битовую строку
    @param size размер массива
    @param unused_bits количество неипользуемых младших бит в последнем байте массива
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param pp_str указатель на переменную, в которую запишется указатель на строку, содержащую
                  символы '1' и '0', определяющие битовую строку
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param p_val64 указатель на переменную, в которую запишется беззнаковое число,
                   двоичное представление которого определяет битовую строку
    @param p_used_bits указатель на переменную, в которую запишется количество младших бит,
                       которые задают битовою строку
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------------------------- */
/*! @param p_bit_str указатель на структуру, хранящую данные типа Bit string
    @param pp_data указатель на переменную, в которую запишется указатель на массив байтов,
                   которые определяют битовую строку
    @param p_size указатель на переменную, в которую запишется размер массива
    @param p_unused_bits указатель на переменную, в которую запишется количество неипользуемых
                         младших бит в последнем байте массива
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/*! @param oid идентификатор объекта
    @param pp_desc указатель на переменную, в которую запишется описание идентификатора, если он
                   будет найден в библиотеке, иначе запишется NULL
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
